    ...
    public partial class SeedSampleData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                INSERT INTO [Tenants] ([Id], [PackageId], [BusinessName], [TaxCode], [OwnerEmail], [OwnerPhone], [SubscriptionStatus], [TokenBalance], [CreatedAt], [UpdatedAt])
                VALUES
                ...
                INSERT INTO [Roles] ([Id], [TenantId], [RoleName], [RoleKey], [Description], [CreatedAt])
                VALUES
                ...
                INSERT INTO [Users] ([Id], [TenantId], [FullName], [Email], [Phone], [PasswordHash], [IsActive], [CreatedAt])
                VALUES
                ...
                INSERT INTO [Properties] ([Id], [TenantId], [PropertyName], [Address], [PropertyType], [CreatedAt])
                VALUES
                ...
                INSERT INTO [UserPropertyMapping] ([UserId], [PropertyId])
                VALUES
                ...
                INSERT INTO [Assets] ([Id], [TenantId], [AssetName], [Brand], [Model], [AssetCode], [PurchaseDate], [WarrantyExpiryDate], [BaseValue], [CreatedAt])
                VALUES
                ...
                INSERT INTO [AssetAssignments] ([Id], [TenantId], [AssetId], [RoomId], [Status], [Note], [AssignedAt])
                VALUES
                ...
                INSERT INTO [Residents] ([Id], [TenantId], [FullName], [Phone], [Email], [IdentityCardNumber], [IdFrontImageUrl], [IdBackImageUrl], [ProfileImageUrl], [CreatedAt])
                VALUES
                ...
                INSERT INTO [Brokers] ([Id], [TenantId], [FullName], [Phone], [WalletBalance], [TotalCommissionEarned])
                VALUES
                ...
                INSERT INTO [Bookings] ([Id], [TenantId], [PropertyId], [RoomId], [GuestName], [GuestPhone], [GuestEmail], [BookingType], [CheckInDate], [CheckOutDate], [Amount], [PaymentStatus], [PaymentTransactionId], [CreatedAt])
                VALUES
                ...
                INSERT INTO [Contracts] ([Id], [TenantId], [PropertyId], [RoomId], [ResidentId], [BrokerId], [BookingId], [StartDate], [EndDate], [DepositAmount], [BrokerCommission], [CommissionStatus], [ContractPdfUrl], [Status], [CreatedAt])
                VALUES
                ...
                INSERT INTO [Invoices] ([Id], [TenantId], [ContractId], [BookingId], [InvoicePeriod], [RoomPrice], [ServicesPrice], [TotalAmount], [QrCodeUrl], [Status], [PaidAt], [CreatedAt])
                VALUES
                ...
                INSERT INTO [Technicians] ([Id], [TenantId], [FullName], [Phone], [Specialty], [IsAvailable])
                VALUES
                ('13131313-1313-1313-1313-131313131311', '33333333-3333-3333-3333-333333333331', N'Le Van Technician', '0901000005', N'Electrical', 1);

                INSERT INTO [MaintenanceTickets] ([Id], [TenantId], [RoomId], [ResidentId], [AssetAssignmentId], [Category], [UserDescription], [IncidentImageUrl], [Status], [TechnicianId], [ResolvedImageUrl], [CreatedAt], [UpdatedAt])
                VALUES
                ...
                INSERT INTO [UserAccessTokens] ([Id], [UserId], [TokenHash], [ExpiresAt], [RevokedAt], [CreatedAt], [CreatedByIp], [RevokedByIp])
                VALUES
                ...
                INSERT INTO [UserRefreshTokens] ([Id], [UserId], [TokenHash], [ExpiresAt], [RevokedAt], [CreatedAt], [CreatedByIp], [RevokedByIp], [ReplacedByTokenHash])
                VALUES
        ...
        {
            migrationBuilder.Sql("""
                DELETE FROM [UserRefreshTokens] WHERE [Id] = '16161616-1616-1616-1616-161616161611';
                DELETE FROM [UserAccessTokens] WHERE [Id] = '15151515-1515-1515-1515-151515151511';
                ...
                DELETE FROM [UserPropertyMapping] WHERE [UserId] = '55555555-5555-5555-5555-555555555551' AND [PropertyId] = '66666666-6666-6666-6666-666666666661';
                ...
                DELETE FROM [UserRoles] WHERE [UserId] = '55555555-5555-5555-5555-555555555551' AND [RoleId] = '44444444-4444-4444-4444-444444444441';
                DELETE FROM [Users] WHERE [Id] = '55555555-5555-5555-5555-555555555551';
                ...
                DELETE FROM [Tenants] WHERE [Id] = '33333333-3333-3333-3333-333333333331';
