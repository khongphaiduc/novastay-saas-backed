...
namespace NovaStay.Infrastructure.Migrations
{
    ...
    [Migration("20260621063022_SeedExpandedDemoData")]
    partial class SeedExpandedDemoData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaStay.Infrastructure.Models.AccountAccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_AccountAccessTokens");

                    b.HasIndex(new[] { "AccountId", "ExpiresAt" }, "IX_AccountAccessTokens_AccountId_ExpiresAt");

                    b.HasIndex(new[] { "TokenHash" }, "IX_AccountAccessTokens_TokenHash");

                    b.ToTable("AccountAccessTokens");
                });
            ...
            modelBuilder.Entity("NovaStay.Infrastructure.Models.Account", b =>
                {
                    b.Navigation("AccountAccessTokens");
