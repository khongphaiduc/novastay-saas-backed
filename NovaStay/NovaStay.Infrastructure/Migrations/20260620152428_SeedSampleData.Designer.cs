...
namespace NovaStay.Infrastructure.Migrations
{
    ...
    [Migration("20260620152428_SeedSampleData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaStay.Infrastructure.Models.AccountAccessToken", b =>
                {
                    ...
                    b.HasIndex(new[] { "StaffUserId", "ExpiresAt" }, "IX_AccountAccessTokens_UserId_ExpiresAt");
            ...
            modelBuilder.Entity("NovaStay.Infrastructure.Models.AccountRefreshToken", b =>
                {
                    ...
                    b.HasIndex(new[] { "StaffUserId", "ExpiresAt" }, "IX_AccountRefreshTokens_UserId_ExpiresAt");
            ...
            modelBuilder.Entity("NovaStay.Infrastructure.Models.AccountAccessToken", b =>
                {
                    b.HasOne("NovaStay.Infrastructure.Models.StaffUser", "StaffUser")
                        .WithMany("AccountAccessTokens")
                        .HasForeignKey("StaffUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_AccountAccessTokens_Users_UserId");
            ...
            modelBuilder.Entity("NovaStay.Infrastructure.Models.AccountRefreshToken", b =>
                {
                    b.HasOne("NovaStay.Infrastructure.Models.StaffUser", "StaffUser")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_AccountRefreshTokens_Users_UserId");
